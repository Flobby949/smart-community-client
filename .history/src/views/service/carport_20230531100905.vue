<template>
	...
	<div class="bg-white shadow-lg rounded-lg overflow-hidden m-8">
		<h3 class="font-semibold text-lg mb-2 text-center mt-4">车牌号: {{ carportData.parkId }}</h3>
		<img class="w-full h-64 object-cover object-center" src="https://s1.ax1x.com/2023/05/31/p9vJN1U.png" alt="Car Image" />
		<div class="p-4">
			<p class="text-gray-700 text-base text-center">车位号: {{ carportData.carportName }}</p>
		</div>
	</div>
	<div class="bg-white mx-4 my-2 border border-gray border-solid overflow-hidden">
		<div class="p-4">
			...
			<div class="flex items-center mb-2">
				...
				<p class="text-gray-800">{{ carportData.startTime }}</p>
			</div>
			<div class="flex items-center mb-2">
				<svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-1 text-blue-500" viewBox="0 0 20 20" fill="currentColor">
					<path fill-rule="evenodd" d="M13 9a4 4 0 11-8 0 4 4 0 018 0zm-1.75 2.25a2.5 2.5 0 10-3.5 0l-.5.5v.5h4.5v-.5l-.5-.5z" clip-rule="evenodd" />
				</svg>
				<p class="text-gray-800">{{ carportData.endTime }}</p>
			</div>
