		...
		<div class="bg-white mx-4 my-2 border border-gray border-solid overflow-hidden">
			<div class="p-4">
				<div class="flex pb-3 border-dashed border-b-2 border-gray-400">
					...
					<button
						class="bg-white py-2 px-4 border border-blue-500 rounded-full font-bold text-blue-500 hover:text-white hover:bg-blue-500 focus:outline-none focus:shadow-outline-blue"
					>
						解除绑定
					</button>
				</div>
