		...
		<div class="bg-white mx-4 my-2 border border-gray border-solid overflow-hidden">
			<div class="p-4">
				<div class="flex pb-3 border-dashed border-b-2 border-gray-400">
					...
					<button
						class="bg-white rounded-full border-1 border-blue-500 text-blue-500 py-2 px-4 hover:bg-blue-500 hover:text-white transition duration-300 ease-in-out ml-[140px]"
					>
						解除绑定
					</button>
				</div>
