	...
	<div class="box">
		...
		<div class="vant-form">
			<van-cell-group>
				...
				<!-- <van-select v-model="form.parkId" placeholder="请选择">
					<van-option v-for="item in communityList" :key="item.id" :value="item.id" :label="item.communityName" />
				</van-select> -->
				<van-dropdown-menu v-model="form.communityId">
					<van-dropdown-item v-for="community in communityList" :key="community.id" :value="community.communityName">
						{{ community.communityName }}
					</van-dropdown-item>
				</van-dropdown-menu>
				<p>Selected Community ID: {{ form.communityId }}</p>
				<!-- <p>Selected Community Name: {{ community.communityName }}</p> -->
				<!-- <van-dropdown-menu v-model="form.parkId">
					<van-dropdown-item v-for="item in communityList" :key="item.id" :options="item.communityName" />
				</van-dropdown-menu> -->
