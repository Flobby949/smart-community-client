	...
	<div class="box">
		...
		<div class="vant-form">
			<van-cell-group>
				...
				<van-popup v-model="form.parkId" round position="bottom" label="停车场名字">
					<van-picker v-for="item in communityList" :columns="item.id" :key="item.id" :value="item.parkName" show-toolbar title="选择选项" />
				</van-popup>
