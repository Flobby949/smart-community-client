		...
		<template v-for="(item, index) in list" :key="index">
			<div class="flex flex-col m-10 mt-15">
				...
				<div class="bg-white rounded-lg shadow-md p-4 mb-4">
					<div class="flex">
						<img src="https://s1.ax1x.com/2023/06/01/p9zpFmj.png" class="w-[33px]" alt="" />
						<h2 class="text-[30px] font-bold mb-2">{{ item.licence }}</h2>
					</div>

					<div class="border border-dashed border-gray-300 h-0.5 w-full mt-5 mb-4"></div>
